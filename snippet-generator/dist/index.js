...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mappings, _loop_1, _i, mappings_1, d;
    return __generator(this, function (_a) {
        mappings = Data.mappings;
        _loop_1 = function (d) {
            fs.readFile(d.data.filepath, "utf-8", function (err, data) {
                var lines = data.split('\n');
                var snippetData = (0, gen_1.getSnippet)(lines);
                var snippetObj = {
                    scope: "cpp",
                ...
                fs.writeFile("../snippets/" + d.data.name + ".code-snippets", JSON.stringify(jsonObj), function (err) {
                    if (err) {
                        console.error(err);
                    }
                    else {
